export const ToggleMenuSVG = ()=>{
    return <svg width="32px" height="32x" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const CloseSVG = ()=>{
    return <svg width="32px" height="32px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g id="Menu / Close_LG">
